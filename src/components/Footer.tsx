...
function Footer() {
  return (
    <div
      id="contact"
      className="bg-primary md:px-[150px] pt-5 px-[16px] pb-10 text-[#FBFFFE] lg:h-[400px] lg:flex items-center justify-center"
    >
      <div className="lg:flex lg:gap-12 space-y-8 lg:space-y-0">
        ...
        <div className="flex flex-col space-y-5">
          <div className="flex space-x-2 items-center">
            {<MapPin />}
            <h2 className="text-[#FFCC33] md:font-semibold font-bold lg:text-2xl">
              Jayanagar
            </h2>
          </div>
          <p className="text-[14px]">
            69, 9th Main Rd, Jayanagar 3rd Block East, Bengaluru, Karnataka
            560011
          </p>
        ...
        <div className="flex flex-col space-y-5">
          ...
          <p className="text-[14px]">
            No A/2, Inner Cir Rd, Whitefield, Dodsworth Layout, Bengaluru,
            Karnataka 560066
          </p>
