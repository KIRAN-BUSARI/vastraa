    ...
    <section className="min-h-[80vh]">
      <div className="flex space-x-6">
        ...
        <div className="space-y-4">
          <h1 className="font-bold md:text-4xl text-3xl leading-[45px] text-primary md:font-medium">
            Fashion, <span className="text-gradient">Maternity, </span>{" "}
            <br className="md:hidden" />
            Pre-Wedding,{" "}
            <span className="text-gradient">Bridal Collections</span> & More!
          </h1>
          <p className="text-primary font-normal leading-[140%] xl:text-xl md:text-xs">
            Explore our extensive collection of costumes, including fashion,
            maternity, pre-wedding, and bridal wear.{" "}
            <br className="hidden md:block" /> Find the perfect attire for every
            special occasion in one place.
          </p>
        </div>
      </div>
