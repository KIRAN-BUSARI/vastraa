import img1 from "../assets/costume1.png";
...
function Costume() {
  return (
    <section
      id="costumes"
      className="min-h-screen md:mb-32 mb-24 pt-40 md:mt-20 -mt-20"
    >
      <div className="flex space-x-6">
        <div className="bg-gradient lg:h-[104px] lg:min-w-[8px] min-w-[8px] border rounded-full"></div>
        <div className="space-y-4">
          <h1 className="font-bold md:text-4xl text-3xl text-primary md:font-medium">
            Cool Costume Collection!
          </h1>
