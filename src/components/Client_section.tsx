    ...
    >
      <div className="w-full mt-20">
        <div className="flex space-x-4">
          <div className="flex justify-center flex-col text-center space-y-2">
            <h1 className="text-primary font-semibold text-3xl lg:mt-32 text-start">
              Our Clients
            </h1>
            <p className="text-primary font-normal text-start">
              Our clients are at the heart of everything we do. We pride
              ourselves on delivering personalized, top-notch service to meet
              their unique needs. <br className="hidden md:block" />
      ...
      <div className="w-full flex overflow-hidden lg:space-x-8 group lg:mx-[20px] mt-10">
        <div className="flex lg:space-x-8 space-x-8 w-full lg:justify-center lg:items-center animate-scroll group-hover:paused gap-x-8">
          {pics.map((pic) => (
            <img src={pic.image} alt="img" className="h-1/2 w-1/2" />
          ))}
        </div>
      </div>
    </section>
